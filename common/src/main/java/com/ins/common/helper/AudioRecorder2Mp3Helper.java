 ...
 */
public class AudioRecorder2Mp3Helper {
	/**
	 ...
	 * @param activity
	 */
	public AudioRecorder2Mp3Helper(Activity activity) {
	 ...
	 * @param mp3Path
	 */
	public AudioRecorder2Mp3Helper(Activity activity, String rawPath,
                                   String mp3Path) {
		this.activity = activity;
	 ...
	 */
	class Sample {
		AudioRecorder2Mp3Helper util = null;
		String mp3 = null;
		String raw = null;

		void start() {
			// util=new AudioRecorder2Mp3Helper(activity); 一般是用这个
			if (util == null)
				util = new AudioRecorder2Mp3Helper(null, "/sdcard/sample.raw",
						"/sdcard/sample.mp3");
