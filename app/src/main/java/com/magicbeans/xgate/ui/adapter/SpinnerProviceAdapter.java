...
public class SpinnerProviceAdapter extends BaseAdapter {
    ...
    private List<Province> results = new ArrayList<>();

    public List<Province> getResults() {
        return results;
    }

    public SpinnerProviceAdapter(Context pContext) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        final Province province = results.get(position);

        holder.text_title.setText(province.getName());
