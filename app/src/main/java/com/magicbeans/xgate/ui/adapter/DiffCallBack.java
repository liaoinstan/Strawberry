...
public class DiffCallBack extends DiffUtil.Callback {
    ...
    public int getOldListSize() {
        return resultsOld != null ? resultsOld.size() : 0;
    }

    //新数据集size
    @Override
    public int getNewListSize() {
        return resultsNew != null ? resultsNew.size() : 0;
    }
    ...
    public boolean areItemsTheSame(int oldItemPosition, int newItemPosition) {
        return resultsOld.get(oldItemPosition).getProdID().equals(resultsNew.get(newItemPosition).getProdID());
    }
